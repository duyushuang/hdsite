webpackJsonp([2], {
    1358: function (t, e, r) {
        ...
        var n = r(1359),
            a = r.n(n);
        if (/\.zhihu\.com$/i.test(window.location.hostname)) {
            a.a.config("https://6d944a32a51347d6a182292b943c6733@crash2.zhihu.com/197").install(), window.Raven = a.a;
            var i = function (t) {
                console.error(t), a.a.captureException(t)
            };
    ...
    1360: function (t, e, r) {
        ...
        (function (e) {
            ...
            function i() {
                this._hasJSON = !("object" != typeof JSON || !JSON.stringify), this._hasDocument = !o(U), this._hasNavigator = !o(L), this._lastCapturedException = null, this._lastData = null, this._lastEventId = null, this._globalServer = null, this._globalKey = null, this._globalProject = null, this._globalContext = {}, this._globalOptions = {
                    logger: "javascript",
                    ignoreErrors: [],
                    ignoreUrls: [],
                    whitelistUrls: [],
            ...
            function g(t) {
                for (var e, r = [], n = 0, a = t.length; n < a; n++) e = t[n], l(e) ? r.push(e.replace(/([.*+?^=!:${}()|\[\]\/\\])/g, "\\$1")) : e && e.source && r.push(e.source);
            ...
            function b(t) {
                for (var e, r = [], n = 0, a = 0, i = " > ".length; t && n++ < 5 && !("html" === (e = y(t)) || n > 1 && a + r.length * i + e.length >= 80);) r.push(e), a += e.length, t = t.parentNode;
            ...
            function y(t) {
                ...
                if (o.push(t.tagName.toLowerCase()), t.id && o.push("#" + t.id), (e = t.className) && l(e))
                    for (r = e.split(/\s+/), i = 0; i < r.length; i++) o.push("." + r[i]);
                var s = ["type", "name", "title", "alt"];
                for (i = 0; i < s.length; i++) n = s[i], (a = t.getAttribute(n)) && o.push("[" + n + '="' + a + '"]');
                return o.join("")
            }
            ...
            function E(t, e) {
                return !x(t, e) && (t = t.values[0], e = e.values[0], t.type === e.type && t.value === e.value && k(t.stacktrace, e.stacktrace))
            }
            ...
            function k(t, e) {
                ...
                for (var a, i, o = 0; o < r.length; o++)
                    if (a = r[o], i = n[o], a.filename !== i.filename || a.lineno !== i.lineno || a.colno !== i.colno || a.function !== i.function) return !1;
                return !0
            }

            function w(t, e, r, n) {
                var a = t[e];
                t[e] = r(a), n && n.push([t, e, a])
            }
            var S = r(1361),
                O = r(1362),
                C = r(1363),
            ...
            i.prototype = {
                ...
                config: function (t, e) {
                    ...
                    }), r.setDSN(t), n.ignoreErrors.push(/^Script error\.?$/), n.ignoreErrors.push(/^Javascript error: Script error\.? on line 0$/), n.ignoreErrors = g(n.ignoreErrors), n.ignoreUrls = !!n.ignoreUrls.length && g(n.ignoreUrls), n.whitelistUrls = !!n.whitelistUrls.length && g(n.whitelistUrls), n.includePaths = g(n.includePaths), n.maxBreadcrumbs = Math.max(0, Math.min(n.maxBreadcrumbs || 100, 100));
                    var a = {
                            xhr: !0,
                            console: !0,
                            dom: !0,
                        ...
                        i = n.autoBreadcrumbs;
                    "[object Object]" === {}.toString.call(i) ? i = h(a, i) : !1 !== i && (i = a), n.autoBreadcrumbs = i;
                    var o = {
                            tryCatch: !0
                        },
                        s = n.instrument;
                    return "[object Object]" === {}.toString.call(s) ? s = h(o, s) : !1 !== s && (s = o), n.instrument = s, S.collectWindowErrors = !!n.collectWindowErrors, r
                },
                install: function () {
                    var t = this;
                ...
                setDSN: function (t) {
                    var e = this,
                        ...
                        a = r.path.substr(1, n);
                    e._dsn = t, e._globalKey = r.user, e._globalSecret = r.pass && r.pass.substr(1), e._globalProject = r.path.substr(n + 1), e._globalServer = e._getGlobalServer(r), e._globalEndpoint = e._globalServer + "/" + a + "api/" + e._globalProject + "/store/", this._resetBackoff()
                },
                context: function (t, e, r) {
                    return s(t) && (r = e || [], e = t, t = void 0), this.wrap(t, e).apply(this, r)
                },
                wrap: function (t, e, r) {
                    function n() {
                        var n = [],
                            i = arguments.length,
                            o = !t || t && !1 !== t.deep;
                        for (r && s(r) && r.apply(this, arguments); i--;) n[i] = o ? a.wrap(t, arguments[i]) : arguments[i];
                        try {
                            return e.apply(this, n)
                        } catch (e) {
                            throw a._ignoreNextOnError(), a.captureException(e, t), e
                        }
                    }
                    var a = this;
                    if (o(e) && !s(t)) return t;
                    ...
                    for (var i in e) d(e, i) && (n[i] = e[i]);
                    return n.prototype = e.prototype, e.__raven_wrapper__ = n, n.__raven__ = !0, n.__inner__ = e, n
                },
                uninstall: function () {
                ...
                setDataCallback: function (t) {
                    ...
                    return this._globalOptions.dataCallback = a(e, t), this
                },
                setBreadcrumbCallback: function (t) {
                    var e = this._globalOptions.breadcrumbCallback;
                    return this._globalOptions.breadcrumbCallback = a(e, t), this
                },
                setShouldSendCallback: function (t) {
                    var e = this._globalOptions.shouldSendCallback;
                    return this._globalOptions.shouldSendCallback = a(e, t), this
                },
                ...
                showReportDialog: function (t) {
                    if (U) {
                        ...
                        var n = encodeURIComponent,
                            a = "";
                        a += "?eventId=" + n(e), a += "&dsn=" + n(r);
                        var i = t.user || this._globalContext.user;
                        i && (i.name && (a += "&name=" + n(i.name)), i.email && (a += "&email=" + n(i.email)));
                        var o = this._getGlobalServer(this._parseDSN(r)),
                            s = U.createElement("script");
                        s.async = !0, s.src = o + "/api/embed/error-page/" + a, (U.head || U.body).appendChild(s)
                    }
                },
                ...
                _triggerEvent: function (t, e) {
                    ...
                    if (this._hasDocument) {
                        e = e || {}, t = "raven" + t.substr(0, 1).toUpperCase() + t.substr(1), U.createEvent ? (r = U.createEvent("HTMLEvents"), r.initEvent(t, !0, !0)) : (r = U.createEventObject(), r.eventType = t);
                ...
                _keypressEventHandler: function () {
                    ...
                    return function (e) {
                        ...
                        if (n && ("INPUT" === n || "TEXTAREA" === n || r.isContentEditable)) {
                            ...
                            a || t._breadcrumbEventHandler("input")(e), clearTimeout(a), t._keypressTimeout = setTimeout(function () {
                ...
                _captureUrlChange: function (t, e) {
                    var r = v(this._location.href),
                        n = v(e),
                        a = v(t);
                    this._lastHref = e, r.protocol === n.protocol && r.host === n.host && (e = n.relative), r.protocol === a.protocol && r.host === a.host && (t = a.relative), this.captureBreadcrumb({
                        category: "navigation",
                        data: {
                            to: e,
                            from: t
                ...
                _instrumentTryCatch: function () {
                    function t(t) {
                        return function (r, n) {
                            ...
                            var o = a[0];
                            return s(o) && (a[0] = e.wrap(o)), t.apply ? t.apply(this, a) : t(a[0], a[1])
                        }
                    }
                    var e = this,
                        r = e._wrappedBuiltIns,
                        n = this._globalOptions.autoBreadcrumbs;
                    w(N, "setTimeout", t, r), w(N, "setInterval", t, r), N.requestAnimationFrame && w(N, "requestAnimationFrame", function (t) {
                        return function (r) {
                            return t(e.wrap(r))
                        }
                    }, r);
                    for (var a = ["EventTarget", "Window", "Node", "ApplicationCache", "AudioTrackList", "ChannelMergerNode", "CryptoOperation", "EventSource", "FileReader", "HTMLUnknownElement", "IDBDatabase", "IDBRequest", "IDBTransaction", "KeyOperation", "MediaController", "MessagePort", "ModalWindow", "Notification", "SVGElementInstance", "Screen", "TextTrack", "TextTrackCue", "TextTrackList", "WebSocket", "WebSocketWorker", "Worker", "XMLHttpRequest", "XMLHttpRequestEventTarget", "XMLHttpRequestUpload"], i = 0; i < a.length; i++) ! function (t) {
                        var a = N[t] && N[t].prototype;
                        a && a.hasOwnProperty && a.hasOwnProperty("addEventListener") && (w(a, "addEventListener", function (r) {
                            return function (a, i, o, s) {
                                ...
                                }), r.call(this, a, e.wrap(i, void 0, l), o, s)
                            }
                        }, r), w(a, "removeEventListener", function (t) {
                ...
                _instrumentBreadcrumbs: function () {
                    ...
                    if (r.xhr && "XMLHttpRequest" in N) {
                        ...
                        w(a, "open", function (t) {
                            ...
                            return function (n) {
                                ...
                                for (var i = this, o = ["onload", "onerror", "onprogress"], l = 0; l < o.length; l++) t(o[l], i);
                                return "onreadystatechange" in i && s(i.onreadystatechange) ? w(i, "onreadystatechange", function (t) {
                                    return e.wrap(t, void 0, a)
                                }) : i.onreadystatechange = a, r.apply(this, arguments)
                            }
                        }, n)
                    }
                    r.xhr && "fetch" in N && w(N, "fetch", function (t) {
                        return function (r, n) {
                            for (var a = new Array(arguments.length), i = 0; i < a.length; ++i) a[i] = arguments[i];
                            var o, s = a[0],
                                l = "GET";
                            "string" == typeof s ? o = s : (o = s.url, s.method && (l = s.method)), a[1] && a[1].method && (l = a[1].method);
                            var c = {
                                method: l,
                                url: o,
                                status_code: null
                    ...
                    }, n), r.dom && this._hasDocument && (U.addEventListener ? (U.addEventListener("click", e._breadcrumbEventHandler("click"), !1), U.addEventListener("keypress", e._keypressEventHandler(), !1)) : (U.attachEvent("onclick", e._breadcrumbEventHandler("click")), U.attachEvent("onkeypress", e._keypressEventHandler())));
                    var i = N.chrome,
                        o = i && i.app && i.app.runtime,
                ...
                _prepareFrames: function (t, e) {
                    ...
                    if (t.stack && t.stack.length && (u(t.stack, function (t, e) {
                        ...
                        for (var a = 0; a < e.trimHeadFrames && a < n.length; a++) n[a].in_app = !1;
                ...
                _processException: function (t, e, r, n, a, i) {
                    var o;
                    if ((!this._globalOptions.ignoreErrors.test || !this._globalOptions.ignoreErrors.test(e)) && (e += "", a && a.length ? (r = a[0].filename || r, a.reverse(), o = {
                            frames: a
                        }) : r && (o = {
                            frames: [{
                                filename: r,
                ...
                _trimPacket: function (t) {
                    ...
                    var n = t.request;
                    return n && (n.url && (n.url = p(n.url, this._globalOptions.maxUrlLength)), n.Referer && (n.Referer = p(n.Referer, this._globalOptions.maxUrlLength))), t.breadcrumbs && t.breadcrumbs.values && this._trimBreadcrumbs(t.breadcrumbs), t
                },
                _trimBreadcrumbs: function (t) {
                    for (var e, r, n, a = ["to", "from", "url"], i = 0; i < t.values.length; ++i)
                        if (r = t.values[i], r.hasOwnProperty("data") && D(r.data) && !f(r.data)) {
                            n = h({}, r.data);
                            for (var o = 0; o < a.length; ++o) e = a[o], n.hasOwnProperty(e) && (n[e] = p(n[e], this._globalOptions.maxUrlLength));
                            t.values[i].data = n
                        }
                },
                _getHttpData: function () {
                    if (this._hasNavigator || this._hasDocument) {
                        ...
                        }), this._hasDocument && (U.location && U.location.href && (t.url = U.location.href), U.referrer && (t.headers || (t.headers = {}), t.headers.Referer = U.referrer)), t
                    }
                },
                ...
                _isRepeatData: function (t) {
                    ...
                    return !(!e || t.message !== e.message || t.culprit !== e.culprit) && (t.stacktrace || e.stacktrace ? k(t.stacktrace, e.stacktrace) : !t.exception && !e.exception || E(t.exception, e.exception))
                },
                _setBackoffState: function (t) {
                    if (!this._shouldBackoff()) {
                        ...
                        if (400 === e || 401 === e || 429 === e) {
                            ...
                            this._backoffDuration = r || (2 * this._backoffDuration || 1e3), this._backoffStart = n()
                        }
                    }
                },
                _send: function (t) {
                    var e = this._globalOptions,
                        ...
                        a = this._getHttpData();
                    if (a && (r.request = a), t.trimHeadFrames && delete t.trimHeadFrames, t = h(r, t), t.tags = h(h({}, this._globalContext.tags), t.tags), t.extra = h(h({}, this._globalContext.extra), t.extra), t.extra["session:duration"] = n() - this._startTime, this._breadcrumbs && this._breadcrumbs.length > 0 && (t.breadcrumbs = {
                ...
                _makeRequest: function (t) {
                    ...
                    if ("withCredentials" in e || "undefined" != typeof XDomainRequest) {
                        ...
                        "withCredentials" in e ? e.onreadystatechange = function () {
                            ...
                            r.request = e, t.onError(r)
                        })), e.open("POST", r + "?" + _(t.auth)), e.send(O(t.data))
                    }
                },
        ...
        (function (e) {
            ...
            i.report = function () {
                ...
                function h(t, e, r, o, s) {
                    var h = null;
                    if (x) i.computeStackTrace.augmentStackTraceWithInitialElement(x, e, r, t), d();
                    else if (s && a.isError(s)) h = i.computeStackTrace(s), u(h, !0);
                    else {
                        var f, p = {
                                url: e,
                                line: r,
                ...
                function f() {
                    v || (_ = o.onerror, o.onerror = h, v = !0)
                }

                function p() {
                    v && (o.onerror = _, v = !1, _ = void 0)
                }

                function d() {
                    var t = x,
                        e = b;
                    b = null, x = null, y = null, u.apply(null, [t, !1].concat(e))
                }
                ...
                function t(t) {
                    if (void 0 !== t.stack && t.stack) {
                        for (var e, r, a, i = /^\s*at (.*?) ?\(((?:file|https?|blob|chrome-extension|native|eval|webpack|<anonymous>|\/).*?)(?::(\d+))?(?::(\d+))?\)?\s*$/i, o = /^\s*(.*?)(?:\((.*?)\))?(?:^|@)((?:file|https?|blob|chrome|webpack|resource|\[native).*?|[^@]*bundle)(?::(\d+))?(?::(\d+))?\s*$/i, s = /^\s*at (?:((?:\[object object\])?.+) )?\(?((?:file|ms-appx|https?|webpack|blob):.*?):(\d+)(?::(\d+))?\)?\s*$/i, c = /(\S+) line (\d+)(?: > eval line \d+)* > eval/i, u = /\((\S*)(?::(\d+))(?::(\d+))\)/, h = t.stack.split("\n"), f = [], p = (/^(.*) is undefined$/.exec(t.message), 0), d = h.length; p < d; ++p) {
                            if (r = i.exec(h[p])) {
                                var g = r[2] && 0 === r[2].indexOf("native"),
                                    _ = r[2] && 0 === r[2].indexOf("eval");
                                _ && (e = u.exec(r[2])) && (r[2] = e[1], r[3] = e[2], r[4] = e[3]), a = {
                                    url: g ? null : r[2],
                                    func: r[1] || l,
                                    args: g ? [r[2]] : [],
                                    line: r[3] ? +r[3] : null,
                                ...
                                if (!(r = o.exec(h[p]))) continue;
                                var _ = r[3] && r[3].indexOf(" > eval") > -1;
                                _ && (e = c.exec(r[3])) ? (r[3] = e[1], r[4] = e[2], r[5] = null) : 0 !== p || r[5] || void 0 === t.columnNumber || (f[0].column = t.columnNumber + 1), a = {
                                    url: r[3],
                                    func: r[1] || l,
                                    args: r[2] ? r[2].split(",") : [],
                                    line: r[4] ? +r[4] : null,
                            ...
                            }!a.func && a.line && (a.func = l), f.push(a)
                        }
                        return f.length ? {
                            name: t.name,
                            message: t.message,
                ...
                function e(t, e, r, n) {
                    ...
                    if (a.url && a.line) {
                        if (t.incomplete = !1, a.func || (a.func = l), t.stack.length > 0 && t.stack[0].url === a.url) {
                            ...
                            if (!t.stack[0].line && t.stack[0].func === a.func) return t.stack[0].line = a.line, !1
                        }
                ...
                function r(t, o) {
                    for (var s, c, u = /function\s+([_$a-zA-Z\xA0-\uFFFF][_$a-zA-Z0-9\xA0-\uFFFF]*)?\s*\(/i, h = [], f = {}, p = !1, d = r.caller; d && !p; d = d.caller)
                        if (d !== a && d !== i.report) {
                            if (c = {
                                    url: null,
                                    func: l,
                ...
                return a.augmentStackTraceWithInitialElement = e, a.computeStackTraceFromStackProp = t, a
            }(), t.exports = i
        }).call(e, r(11))
    },
    1362: function (t, e, r) {
        ...
        function i(t, e) {
            ...
            return null == e && (e = function (t, e) {
                ...
                function (i, o) {
                    if (r.length > 0) {
                        var s = n(r, this);
                        ~s ? r.splice(s + 1) : r.push(this), ~s ? a.splice(s, 1 / 0, i) : a.push(i), ~n(r, o) && (o = e.call(this, i, o))
                    } else r.push(o);
                    return null == t ? o : t.call(this, i, o)
                }
        }
        e = t.exports = a, e.getSerialize = i
    },
    1363: function (t, e, r) {
        "use strict";
        ...
        var n = function (t, e, r) {
            ...
            if (e in t) {
                ...
                t[e] = function () {
                    ...
                    r && r(e, o), n && Function.prototype.apply.call(n, a, t)
                }
            }
        };
        t.exports = {
